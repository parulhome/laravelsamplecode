...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">Save Product</a> </div>
    <h1>Products</h1>
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate">{{ csrf_field() }}
                  ...
                  <div id="uniform-undefined">
                    <table>
                      <tr>
                        ...
                        <td>
                          @if(!empty($productDetails->image))
                            <img style="width:30px;" src="{{ ('/images/'.$productDetails->image) }}"> | <a href="{{ url('/images/'.$productDetails->id) }}">Delete</a>
                          @endif
                        </td>
                      </tr>
                    </table>
              ...
              <div class="form-actions">
                <input type="submit" value="SaveProduct" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
