...
<head>
       <title>Shopping Admin</title><meta charset="UTF-8" />
               ...
               <div class="control-group">
                   <div class="controls">
                       <div class="main_input_box">
                           <span class="add-on bg_lg"><i class="icon-user"> </i></span><input id="email" type="email" name="email" placeholder="Username/email" required="" />
                       </div>
                   </div>
               </div>
               <div class="control-group">
